...
<!-- <script src="http://dapi.kakao.com/v2/maps/sdk.js?appkey=81b614544bac2d13f8e340a9007323f8&libraries=services"></script> -->
              ...
              <table class="table">
                <tr>
                  <td class="text-center">
                    <img :src="loc_detail.poster" style="width:800px;height:600px">
                  </td>
                </tr>
                <tr>
