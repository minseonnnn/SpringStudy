...
<!-- ****** Breadcumb Area Start ****** -->
              ...
              <table class="table">
                <tr>
                  <td class="text-center">
                    <img :src="nat_detail.poster" style="width:800px;height:600px">
                  </td>
                </tr>
                <tr>
                  <td class="text-center"><h4>{{nat_detail.title}}</h4></td>
                <tr>
                <tr>
                  <td class="text-center">{{nat_detail.msg}}</td>
                <tr>
                <tr>
                  <td class="text-center">{{nat_detail.address}}</td>
                <tr>
                <tr>
                  <td class="text-right">
			        ...
			        <div class="option">
			            <div>
			                <form onsubmit="searchPlaces(); return false;">
			                    키워드 : <input type="text" :value="nat_detail.addr+' 맛집'" id="keyword" size="15"> 
    ...
    <script>
      let detailApp=Vue.createApp({
    	  ...
    	  // MVVM => MODEL VUE VUE MODEL => VUE에서 사용하는 디자인 패턴
    	  mounted(){
    		  // 서버로부터 데이터 읽기
