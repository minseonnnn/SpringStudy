...
<!-- ****** Breadcumb Area Start ****** -->
                     ...
                     <table class="table">
                            ...
                            <table class="table">
                             ...
                             <tr>
                               <td colspan="2" class="text-center">
                                 <button class="btn-xs btn-info" @click="prev()">이전</button>
                                  {{curpage}} page / {{totalpage}} pages
                                 <button class="btn-xs btn-primary" @click="next()">다음</button>
                               </td>
                             </tr>
                           </table>
                         </div>
                       ...
                       <td width="30%" height="500" rowspan="2">
                         <table class="table">
                          ...
                          <tr>
                           <td colspan="2" class="text-center">
                             <img :src="image" style="width: 170px; height: 170px">
                           </td>
                          </tr>
                          <tr>
                      ...
                      <tr>
                        <td width="30%" height="150">
                          <table class="table">
                           ...
                           <tr v-show="isTime">
                            <td class="text-center">
                              <span class="btn btn-xs btn-success" v-for="t in time_list" style="magin: 1px"
                              @click="timeSelect(t)"
                              >
                                {{t}}
                              </span>
    ...
    let reserveApp=Vue.createApp({
  	  ...
  	  methods:{
  		  ...
  		  dataRecv(){
  			  ...
  			  // 404(파일명) , 405 (GET/POST) , 400(매개변수 오류) , 500(소스 에러)
    ...
    }).mount("#reserveApp") //section 태그안에 있는 HTML만 제어 
  </script>
</body>
</html>