                           ...
                           <tr>
                            ...
                            <tr>
                              <td colspan="2" class="text-right">
                               총 금액:<span style="color:red">{{total_price}}원</span>
                              </td>
                            </tr>
                            <tr>
                              <td colspan="2" class="text-center">
                               <c:if test="${sessionScope.userId!=null }">
                                <button class="btn-sm btn-primary" @click="goodsCart()">장바구니</button>&nbsp;
                                <button class="btn-sm btn-info" @click="goodsBuy()">바로구매</button>&nbsp;
                               </c:if>
