 ...
 <div id="mypageApp">
   <table class="table">
    ...
    <tr v-for="vo in reserve_list">
      ...
      <td class="text-center">
        <button class="btn-xs btn-primary" v-if="vo.isReserve===1"
         @click="foodInfo(vo.fno,vo.rno)">예약완료</button>
        <button class="btn-xs btn-info" v-else>예약대기</button>
      </td>
    </tr>
   </table>
   <table class="table" v-if="isShow">
     ...
     <td colspan="2">
       <h4>{{reserve_info.fvo.name}}&nbsp;
       <span style="color:orange">{{reserve_info.fvo.score}}</span></h4>
     </td>
     </tr>
     <tr>
