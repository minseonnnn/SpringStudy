          ...
          <table class="table" v-for="rvo in reply_list">
           <tr>
             ...
             <td width=20% class="text-right">
              <span v-if="rvo.id===sessionId">
               <input type=button class="btn btn-xs btn-info ups" value="수정" 
                @click="updateForm(rvo.rno)" :id="'up'+rvo.no"
               >&nbsp;
               <input type=button class="btn btn-xs btn-primary" value="삭제"
           ...
           <tr class="updates" style="display: none" :id="'u'+rvo.rno">
            <td colspan="2">
              ...
              <input type="button" value="댓글수정" style="float: left; width:80px; height: 67px; background-color: silver;"
      ...
      <table class="table" v-if="sessionId!=''">
        <tr>
          <td>
           ...
           <input type="button" value="댓글쓰기" style="float: left;width:80px;height: 67px;background-color: silver;"
            @click="replyInsert()"
           >
          </td>
        </tr>
